//
//  PhotoVideoCollectionViewController.swift
//  WatchMyBack
//
//  Created by Chetu on 7/16/18.
...
struct SelectedMediaData {
    var indexOfMedia: Int?
    var urlOfMedia: URL?
}

class PhotoVideoCollectionViewController: BaseViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        urlOfFiles = DocumentDirecotoryOperations.getListOfFiles(orderToFetch: .descending)
        preViewCollectionView.reloadData()
        setTitle(title: Utility.localized(key: "kMyLog"))
        setBackButton()
        setBarButton()
        managelBarButton()
    }
...
extension PhotoVideoCollectionViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension PhotoVideoCollectionViewController {
    /*
...
extension PhotoVideoCollectionViewController: MFMailComposeViewControllerDelegate{
